...
Public Class DdHelper
    ...
    Private ReadOnly ConectionString As String = ConfigurationManager.ConnectionStrings("ll-46ConnectionString").ConnectionString
    ...
    Public Function GetConnection() As SqlConnection
        Dim conn As New SqlConnection(ConectionString)
        Try
            conn.Open()
